        ...
        <section class="pricing-card-area section-padding30 section-bg" data-background="/wedding/assets/img/gallery/section_bg1.png">
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="section-tittle text-center mb-70">
                            <h2>Pemilihan Gedung</h2>
                            <div class="mt-4">
                                <img src="/wedding/assets/img/gallery/tittle_img.png" alt="">
                                <p>Silakan pilih Gedung, Bila anda kurang berminat harap lanjut ke step selanjutnya</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-card text-center mb-30
                            ...
                            <div class="card-buttons mt-30">
                                {{-- <a href="/custom/create-step-2/{{$paketwo->id}}" class="genric-btn danger circle arrow">Pilih</a> --}}
                ...
                <div class="card-buttons text-center">
                    <a href="/custom/create-step-3/{{$wo->id}}" class="btn card-btn1">Menu Selanjutnya</a>
                </div>
            </div>
            {{-- modal --}}
                @foreach ($products as $paketwo )
                <div class="modal fade mt-5" id="modal-default-{{$paketwo->id}}">
                    ...
                    <div class="modal-content mt-5">
                        ...
                        <a href="/custom/create-step-2/{{$paketwo->id}}/{{$wo->id}}" class="genric-btn info circle arrow">Pilih</a>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                    </div>
