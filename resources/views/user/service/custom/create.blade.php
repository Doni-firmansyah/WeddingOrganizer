<section class="pricing-card-area section-padding30 section-bg" data-background="/wedding/assets/img/gallery/section_bg1.png">
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-lg-8">
                <div class="section-tittle text-center mb-70">
                    <h2>Weding Organizer</h2>
                    <div class="mt-4">
                        <img src="/wedding/assets/img/gallery/tittle_img.png" alt="">
                        <p>Paket Weding Organizer adalah paket Wajib dalam Custom Paket, Mohon pilih salah satu</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                ...
                ">
                    ...
                    <div class="card-buttons mt-30">
                        {{-- <a href="/paket-custom/create/{{$paketwo->id}}" class="genric-btn danger circle arrow">Pilih</a> --}}
        ...
        @foreach ($products as $paketwo )
            <div class="modal fade mt-5" id="modal-default-{{$paketwo->id}}">
                ...
                <div class="modal-content mt-5">
                    ...
                    <a href="/paket-custom/create/{{$paketwo->id}}/{{$wo->id}}" class="genric-btn info circle arrow">Pilih</a>
                    </div>
                </div>
                <!-- /.modal-content -->
                </div>
        ...
        {{-- <div class="card-buttons text-center">
            <a href="/paket-paketwo/create" class="btn card-btn1">Buat paket paketwo</a>
        </div> --}}
    </div>
</section>
