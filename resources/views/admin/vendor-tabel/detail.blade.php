                        ...
                        <div class="col-8 mt-5">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">{{ $no++ }}</th>
                                        <td>{{ $nama=$transaksidetail->product_vendor }}</td>
                                        <td>{{ DB::table('transaksidetails')->where('product_vendor',$nama)->count() }}</td>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $.each(students, function(index, val) {
                myarray[index] = [val.product_vendor, val.count];
            });
